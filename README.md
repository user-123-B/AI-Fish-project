# 組別:B05
# 專題題目: AI Fish:3D視覺化魚群模擬觀測健康系統
# 指導教授: 楊泰寧
# 組員: 資工3B張育嘉、 資工3B猶韋森
# 研究背景:
魚類養殖每年都有因密度過高、水質突變及投餵不精準所造成的死亡。傳統2D監控無法捕捉3D魚群行為，決策延遲可能達數小時。
系統透過AI深度學習融合。                                                         
# 動機:
...
*3D平台：
最終方案：Unity（上手快）Visual studio 2022
適合初學者

*AI模型：
roboflow AI 資料視覺化與標註管理平台呈現
YOLOv8 Nano：魚類偵測
CNN-BiLSTM：健康特徵分析
簡單MLP：快速異常二分類

# 系統架構圖:
<img width="3000" height="1688" alt="image" src="https://github.com/user-attachments/assets/5c463a91-5603-4681-ab27-9c16f310d1da" />
